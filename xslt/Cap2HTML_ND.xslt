...
<xsl:stylesheet xmlns:html="http://www.w3.org/1999/html" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0" xmlns:gml="http://www.opengis.net/gml" xmlns:wfs="http://www.opengis.net/wfs">
	...
	<xsl:template match="WFS_Capabilities">
		<html>
			...
			<body bgcolor="white">
				<table align="center" cellspacing="5">
				<xsl:apply-templates select="*:ServiceIdentification|*:ServiceProvider|*:OperationsMetadata|FeatureTypeList|*:Filter_Capabilities"/>
					<!-- xsl:apply-templates select="*:ServiceIdentification|*:ServiceProvider|*:OperationsMetadata|FeatureTypeList|*:Filter_Capabilities"/ -->
					<!-- xsl:apply-templates select="*:boundedBy|*:member|*/*/*:member|*:featureMember|*:Filter_Capabilities"/ -->
					<tr>
						<td colspan="2" align="center">
							<script>document.write(new Date());</script>
						</td>
	...
	<xsl:template match="*:ServiceIdentification|*:ServiceProvider|*:OperationsMetadata|FeatureTypeList|*:Filter_Capabilities">
		<tr>
			<td colspan="2" bgcolor="silver">
